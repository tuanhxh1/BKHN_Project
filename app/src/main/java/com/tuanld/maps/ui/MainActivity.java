...
import com.tuanld.maps.UserClient;
import com.tuanld.maps.adapters.ChatroomRecyclerAdapter;
import com.tuanld.maps.models.Chatroom;
...
import com.tuanld.maps.service.LocationService;
...
import static com.tuanld.maps.Constants.ERROR_DIALOG_REQUEST;
import static com.tuanld.maps.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.tuanld.maps.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
//          this.startService(serviceIntent);
    ...
    private boolean isLocationServiceRunning() {
        ...
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
            if ("com.tuanld.maps.services.LocationService".equals(service.service.getClassName())) {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "saveUserLocation: \n inserted user location into database." +
                                "\n latitude " + mUserLocation.getmGeoPoint().getLatitude() +
                                "\n longitude " + mUserLocation.getmGeoPoint().getLongitude());
                    }
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                if (task.isSuccessful()) {
                    ...
                    mUserLocation.setmGeoPoint(geoPoint);
